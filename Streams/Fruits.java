...
public static void main(String[] args) {
        ...
        Trader_list.add(new Traders("Kavya", "Telangana"));
        Trader_list.add(new Traders("Sreeja", "Pune"));
        Trader_list.add(new Traders("Saisree", "delhi"));
        Trader_list.add(new Traders("Anusha", "delhi"));
        Trader_list.add(new Traders("Rashi", "Ahemadabad"));
        ...
        List<Transaction> Trans_list = Arrays.asList(
                ...
                new Transaction(new Traders("Kavya", "Delhi"), 2011, 4800),
